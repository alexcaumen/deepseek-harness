...
- button "Pwsh Echo CODE_ROUND_OK" [expanded]:
  - img
  - text: Pwsh Echo CODE_ROUND_OK
- text: "IN { \"command\": \"Write-Output CODE_ROUND_OK\", \"description\": \"Echo CODE_ROUND_OK\" } OUT CODE_ROUND_OK"
- button "Inspect"
- text: Failed
