/** Model-facing discovery constrained to a Session's authorized child routes. */
...
/** Resolve one registered provider with policy-filtered alternatives. */
...
/** Read authorized providers, models, or exact-model efforts. */
...
/**
 * Register fixed-schema route discovery for one Session-scoped delegation tool.
...
export function registerListSubagentModels(
  ...
  ctx.tools.register(defineTool({
    ...
    description:
      ...
      + 'that exact model and its reasoning efforts. Use the returned ids with a delegation tool\'s `provider`, '
