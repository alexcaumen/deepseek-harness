...
export const zh = {
  ...
  'section.sessions': '会话',
  'section.archivedSessions': '已归档会话',
...
export const en = {
  ...
  'section.archivedSessions': 'Archived sessions',
  ...
  'unarchive.failed': 'Could not unarchive: {message}',
  'unarchive.retry': 'Retry',
  'unarchive.pending': 'Unarchiving...',
