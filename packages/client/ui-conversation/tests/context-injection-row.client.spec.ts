...
describe('context producer presentation', () => {
  it('projects upstream package provenance as the owned product name', () => {
    expect(contextProducerLabel('@deepseek-ai/dsh-system-prompt')).toBe('Giana Code Putri')
    expect(contextProducerLabel('@deepseek-ai/dsh-client-runtime')).toBe('Giana Code Putri')
  })
