...
export const zh = {
  ...
  'input.commands': '命令',
  'input.dictation.start': '开始自动语言听写',
  'input.dictation.stop': '停止并转写',
  'input.dictation.stopAndSend': '停止、转写并发送',
  'input.dictation.transcribing': '正在转写…',
  'input.dictation.requestingPermission': '正在请求麦克风权限…',
  'input.dictation.ready': '转写结果可供检查',
  'input.dictation.sending': '正在发送转写结果…',
  'input.dictation.failed': '听写失败：{message}',
  'input.stop': '停止生成',
  'input.send': '发送消息',
  'input.queue': '排队发送',
  'input.steer': '插话发送',
  'input.delivery.label': '运行中消息处理方式',
  'input.delivery.quickQueue': '快速排队',
  'input.delivery.steer': '插话',
  'annotation.toolbar': '所选回复操作',
  'annotation.addToChat': '添加到对话',
  'annotation.item': '批注 {index}：{text}',
  'annotation.sourceMarker': '批注 {index} 来源：{text}',
  'annotation.countOne': '1 条批注',
  'annotation.countMany': '{count} 条批注',
  'annotation.selectedText': '选中文本：',
  'annotation.edit': '编辑批注 {index} 的备注',
  'annotation.delete': '删除批注 {index}',
  'annotation.clear': '移除全部批注',
  'annotation.showSource': '跳转到来源段落',
  'annotation.commentLabel': '批注 {index} 的备注',
  'annotation.commentPlaceholder': '为这段文字添加备注',
  'annotation.save': '保存',
  ...
  'settings.compute.title': '听写计算路由',
  'settings.compute.description': '自动优先检查 R5300，再回退到本机 PRDG。听写使用 Faster Whisper；DOTS 仅用于语音合成。',
  'settings.compute.automatic': '自动',
  'settings.compute.r5300': 'R5300',
  'settings.compute.prdg': 'PRDG',
  'settings.compute.loading': '正在读取计算状态…',
  'settings.compute.status': '当前：{route} · {device} · {state}',
  'settings.compute.failed': '无法读取计算路由：{message}',
  'settings.compute.routeUnavailable': '{route} 不可用；已恢复自动路由。',
  'settings.compute.routeUnavailableDetail': '{route} 不可用（{message}）；已恢复自动路由。',
  'settings.compute.refresh': '刷新状态',
  'settings.compute.checking': '检查中…',
  'settings.modelCompute.title': '本地模型计算路由',
  'settings.modelCompute.description': '自动模式在每次本地模型切换前依次检查 R5300、PRDG，以及仅在模型清单允许时使用内存/CPU。手动选择不可用时不会静默回退。',
  'settings.modelCompute.automatic': '自动',
  'settings.modelCompute.r5300': 'R5300',
  'settings.modelCompute.prdg': 'PRDG',
  'settings.modelCompute.loading': '正在读取模型路由偏好…',
  'settings.modelCompute.unavailable': '此部署未提供模型生命周期设置。',
  'settings.modelCompute.readOnly': '偏好只读；实际目标仍由模型准入和资源预检决定。',
  'settings.modelCompute.savedIntent': '已保存偏好；实际目标将在本地模型推理开始时经过资源预检。',
  'settings.modelCompute.saving': '保存中…',
  'settings.modelCompute.failed': '无法保存模型路由偏好。请刷新状态后重试。',
  ...
  'details.title': '详情',
  'details.open': '打开详情面板',
  'details.toggle': '切换详情面板',
  'details.focus': '切换详情面板全屏',
  'details.close': '关闭详情',
...
export const en = {
  ...
  'input.dictation.start': 'Start automatic-language dictation',
  'input.dictation.stop': 'Stop and transcribe',
  'input.dictation.stopAndSend': 'Stop, transcribe, and send',
  'input.dictation.transcribing': 'Transcribing…',
  'input.dictation.requestingPermission': 'Requesting microphone permission…',
  'input.dictation.ready': 'Transcript ready to review',
  'input.dictation.sending': 'Sending transcribed message…',
  'input.dictation.failed': 'Dictation failed: {message}',
  'input.stop': 'Stop generating',
  'input.send': 'Send message',
  'input.queue': 'Queue message',
  'input.steer': 'Steer current turn',
  'input.delivery.label': 'Message handling while the agent is running',
  'input.delivery.quickQueue': 'Quick queue',
  'input.delivery.steer': 'Steer',
  'annotation.toolbar': 'Selected response actions',
  'annotation.addToChat': 'Add to chat',
  'annotation.item': 'Annotation {index}: {text}',
  'annotation.sourceMarker': 'Annotation {index} source: {text}',
  'annotation.countOne': '1 annotation',
  'annotation.countMany': '{count} annotations',
  'annotation.selectedText': 'Selected text:',
  'annotation.edit': 'Edit comment for annotation {index}',
  'annotation.delete': 'Delete annotation {index}',
  'annotation.clear': 'Remove all annotations',
  'annotation.showSource': 'Show source passage',
  'annotation.commentLabel': 'Comment for annotation {index}',
  'annotation.commentPlaceholder': 'Add a comment for this passage',
  ...
  'settings.compute.title': 'Dictation compute routing',
  'settings.compute.description': 'Automatic checks R5300 first, then falls back to this PRDG. Dictation uses Faster Whisper; DOTS remains text-to-speech only.',
  'settings.compute.automatic': 'Automatic',
  'settings.compute.r5300': 'R5300',
  'settings.compute.prdg': 'PRDG',
  'settings.compute.loading': 'Reading compute status…',
  'settings.compute.status': 'Using {route} · {device} · {state}',
  'settings.compute.failed': 'Compute routing unavailable: {message}',
  'settings.compute.routeUnavailable': '{route} is unavailable; Automatic routing was restored.',
  'settings.compute.routeUnavailableDetail': '{route} is unavailable ({message}); Automatic routing was restored.',
  'settings.compute.refresh': 'Refresh status',
  'settings.compute.checking': 'Checking…',
  'settings.modelCompute.title': 'Local model compute routing',
  'settings.modelCompute.description': 'Automatic checks R5300, then PRDG, then RAM/CPU only when the model manifest permits it. Manual targets fail without silent fallback.',
  'settings.modelCompute.automatic': 'Automatic',
  'settings.modelCompute.r5300': 'R5300',
  'settings.modelCompute.prdg': 'PRDG',
  'settings.modelCompute.loading': 'Reading model routing preference…',
  'settings.modelCompute.unavailable': 'This deployment does not expose model lifecycle settings.',
  'settings.modelCompute.readOnly': 'Preference is read-only; model admission and resource preflight still decide the actual target.',
  'settings.modelCompute.savedIntent': 'Preference saved; resource preflight will decide the actual target when local-model inference starts.',
  'settings.modelCompute.saving': 'Saving…',
  'settings.modelCompute.failed': 'Could not save model routing preference. Refresh status and try again.',
  ...
  'details.open': 'Open details panel',
  'details.toggle': 'Toggle details panel',
  'details.focus': 'Toggle full inspector',
