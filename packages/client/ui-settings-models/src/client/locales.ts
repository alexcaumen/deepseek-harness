...
export const en = {
  ...
  nativeSubscriptionNote: 'Authentication stays in the native client. Giana CoWork does not copy browser cookies or OAuth tokens.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  nativeSubscriptionNote: '身份验证保留在原生客户端中；Giana CoWork 不会复制浏览器 Cookie 或 OAuth 令牌。',
  customTitle: '自定义提供方',
  customTag: '自定义',
  customRoute: 'Provider ID',
