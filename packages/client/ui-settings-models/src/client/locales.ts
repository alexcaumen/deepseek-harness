...
export const en = {
  ...
  codexAccountSlots: 'Codex account slots (optional)',
  slotSignIn: 'Sign in',
  slotSelect: 'Select',
  slotRestartRequired: 'Slot selection takes effect after restart. At most one active Codex slot; ChatGPT subscriptions are separate from API billing.',
  nativeSubscriptionsDescription: 'Use your existing Codex or Claude Code sign-in through the official local client.',
  openCodexSignIn: 'Open Codex sign-in',
  openClaudeSignIn: 'Open Claude Code sign-in',
  nativeSubscriptionNote: 'Authentication stays in the native client. Giana CoWork Preview does not copy browser cookies or OAuth tokens.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  fetchAdopt: '添加所选',
  customAdd: '添加自定义提供方',
  nativeSubscriptions: '原生订阅',
  codexAccountSlots: 'Codex 账户槽位（可选）',
  slotSignIn: '登录',
  slotSelect: '选择',
  slotRestartRequired: '槽位选择在重启后生效。最多一个 Codex 槽位生效；ChatGPT 订阅与 API 计费相互独立。',
  nativeSubscriptionsDescription: '通过官方本地客户端使用现有的 Codex 或 Claude Code 登录。',
  openCodexSignIn: '打开 Codex 登录',
  openClaudeSignIn: '打开 Claude Code 登录',
  nativeSubscriptionNote: '身份验证保留在原生客户端中；Giana CoWork Preview 不会复制浏览器 Cookie 或 OAuth 令牌。',
  customTitle: '自定义提供方',
  customTag: '自定义',
  customRoute: 'Provider ID',
