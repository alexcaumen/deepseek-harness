...
const WEB_SEARCH_RESULT: Omit<Extract<ToolResultView, { card: 'web'; kind: 'search' }>, 'card' | 'kind'> = {
  answer: 'Giana Code is a plugin-based agent workbench where **every capability is composable**.',
  sources: [
    {
      url: 'https://github.com/deepseek-ai/deepseek-harness',
      title: 'Giana Code — composable agent workbench',
...
function buildAlphaLog(stableMessageIds = false): SessionEvent[] {
  ...
  toolTurn(70, 'web_search', '{"queries":["Giana Code architecture"]}', 'Search results for Giana Code architecture.')
